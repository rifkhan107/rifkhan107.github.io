  ...
  return (
    <div className="flex items-center justify-around">
      ...
      <a
        ...
        rel="noopener noreferrer"
        className="p-3 bg-rifkhan/10 rounded-full text-rifkhan hover:bg-rifkhan hover:text-white transition-colors"
        aria-label="AWS Community Builder"
      >
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M18.75 13.5L24 9l-9-4.5L9 9 9.4 9.24 3.75 7.5 0 9l12 6 3.6-1.8-.45-.3 3.6-1.8-.45-.3 3.6-1.8-.45-.3M0 13.5V15l12 6 12-6v-1.5L12 19.5 0 13.5M0 18v1.5L12 24l12-4.5V18l-12 4.5L0 18" />
        </svg>
      </a>
    </div>
  );
